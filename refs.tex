%-------------------------------------------
% Resume in LuaLatex - Referrals Version
...
% Fix bold font issue - map \textbf to use 'bx' series instead of 'mb'
...
% Print Heading
%-------------------------------------------
\directlua{printHeading("./_data/personal.json", 3)}
...
\directlua{printSkills("./_data/personal.json", 3)}
